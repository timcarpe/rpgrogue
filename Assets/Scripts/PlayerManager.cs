...
public class PlayerManager : MonoBehaviour
{
	...
	[Header("Spells")]
	[SerializeField] private int playerSpellPower;
	[SerializeField] private int playerMaxMana;
	[SerializeField] private int playerMana;
	[SerializeField] private int playerManaRegen;
	...
	public void RegenPlayerMana()
	{
		if (playerMana + playerManaRegen < playerMaxMana)
	...
	public int PlayerSpellPower
	{
		get { return playerSpellPower; }
	}
	...
	{
		playerMaxMana = (30 + (conBonus * 5));
	}

	private void CalculateSpellPower()
	{
		playerSpellPower = (10 + (4 * intBonus));
	}

	private void CalculateManaRegen()
	{
		playerManaRegen = 1 + (intBonus / 2);
	}
